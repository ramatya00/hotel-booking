...
export default async function ReservationDetail({ reservationId }: { reservationId: string }) {
				...
				<ul>
					<li className="py-2">
						<div className="flex items-center">
							...
							<div className="inline-flex items-center text-base font-semibold text-gray-900">#{reservationId}</div>
						</div>
					</li>
					<li className="py-2">
						<div className="flex items-center">
				...
				<table className="w-full text-sm text-left text-gray-500 ">
					<thead className="text-xs text-gray-700 uppercase bg-gray-50">
						<tr>
							...
							<th scope="col" className="px-6 py-3 min-w-50 md:min-w-0">Arrival</th>
							<th scope="col" className="px-6 py-3">Departure</th>
							<th scope="col" className="px-6 py-3">Duration</th>
							<th scope="col" className="px-6 py-3 text-right">Sub Total</th>
						</tr>
					</thead>
					<tbody>
						<tr className="bg-white border-b">
							<td className="px-6 py-4">
								<div className="flex flex-col">
									...
									<span className="text-sm text-gray-50">Price: {reservation.room.price}</span>
								</div>
							</td>
